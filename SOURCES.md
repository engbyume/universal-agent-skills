...
This catalog was refreshed from the installed skill directories, plugin metadata, and the local skills lockfile on 2026-09-06.
...
| [engbyume/codex-harness-free-model-router](https://github.com/engbyume/codex-harness-free-model-router) | Public standalone package for a provider-neutral, user-configured Codex model router, local daemon, and fallback panel. |
