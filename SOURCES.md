...
| [engbyume/codex-harness-free-model-router](https://github.com/engbyume/codex-harness-free-model-router) | Public standalone package for the Codex free-model switcher, daemon fallback, and paid GPT lane. |
